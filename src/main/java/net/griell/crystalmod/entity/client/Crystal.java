...
public class Crystal<T extends Entity> extends EntityModel<T> {
	...
	public Crystal(ModelPart root) {
		...
		this.triangle5 = root.getChild("triangle5");
		this.triangle3 = root.getChild("triangle3");
		this.triangle4 = root.getChild("triangle4");
		this.triangle2 = root.getChild("triangle2");
		this.bottom = root.getChild("bottom");
		this.triangle = root.getChild("triangle");
		this.triangle6 = root.getChild("triangle6");
		this.triangle7 = root.getChild("triangle7");
		this.triangle8 = root.getChild("triangle8");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition top = partdefinition.addOrReplaceChild("top", CubeListBuilder.create(), PartPose.offset(0.0F, 31.0F, 11.0F));
		...
		PartDefinition bottom = partdefinition.addOrReplaceChild("bottom", CubeListBuilder.create(), PartPose.offset(0.0F, 23.0F, 11.0F));
		...
		PartDefinition middle = partdefinition.addOrReplaceChild("middle", CubeListBuilder.create().texOffs(12, 68).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 18.0F, 0.0F));

		return LayerDefinition.create(meshdefinition, 128, 128);
	}

	@Override
	public void setupAnim(Crystal entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
